...
public plugin_cfg()
{
	...
	server_cmd(addStast, "Mostre o assassino HP&AP", "KillerChat")
	server_cmd(addStast, "Mostre os Atacantes", "ShowAttackers")
	server_cmd(addStast, "Mostre as Vitimas", "ShowVictims")
	server_cmd(addStast, "Mostre o assassino", "ShowKiller")
	server_cmd(addStast, "Mostre o Score do Time", "ShowTeamScore")
	server_cmd(addStast, "Mostre o Stats Total", "ShowTotalStats")
	server_cmd(addStast, "Mostre o Melhor Score", "ShowBestScore")
	server_cmd(addStast, "Mostre o Mais Destrutivo", "ShowMostDisruptive")
	server_cmd(addStast, "Stats HUD padrao", "ShowStats")
	server_cmd(addStast, "Distancia&HS na lista HUD", "ShowDistHS")
	server_cmd(addStast, "Stats no final do map", "EndPlayer")
	server_cmd(addStast, "Top15 no final do mapa", "EndTop15")
	...
	server_cmd(addStast, "Info de Rank para Espectador", "SpecRankInfo")
