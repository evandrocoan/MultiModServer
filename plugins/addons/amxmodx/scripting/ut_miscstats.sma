...
public plugin_init()
{
	register_plugin("CS Misc. Stats UT", AMXX_VERSION_STR, "AMXX Dev Team")
...
public plugin_cfg()
{
	...
	server_cmd(g_addStast, "Round Count Text", "RoundCounter")
...
public client_death(killer, victim, wpnindex, hitplace, TK)
{
	...
	if ((DoubleKill || DoubleKillSound) && !selfkill)
	{
		...
		if (g_doubleKill == nowtime && g_doubleKillId == killer)
		{
			...
			if (DoubleKillSound)
				play_sound("ultimate_sounds\doublekill_ut")
		}
