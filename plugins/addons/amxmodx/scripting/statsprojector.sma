...
public show_timer(id){
	...
	show_hudmessage(0,"Addons zz^n-------------------------------^nData: %s^nHora: %s^nMapa Atual: %s^n-------------------------------^nTempo Restante: %d:%02d^nProximo Mapa: %s^n-------------------------------^nNick: %s^nFrags: %d       Rank: %d^nMortes: %d     Ping: %d^n-------------------------------^nwww.addons.zz.mu", CurrentTim, CurrentTime, Currentmap, timeleft / 60, timeleft % 60, nextmap, as, iRankPos, os,ping)
