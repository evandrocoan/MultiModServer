...
public plugin_cfg()
{
	...
	server_cmd(g_addStast, "Som de MultiKill", "MultiKillSound")
	server_cmd(g_addStast, "Plantando Bomba", "BombPlanting")
	server_cmd(g_addStast, "Defusando Bomba", "BombDefusing")
	server_cmd(g_addStast, "Bomba Plantada", "BombPlanted")
	server_cmd(g_addStast, "Bomba Defusada", "BombDefused")
	server_cmd(g_addStast, "Falha ao Defusar a Bomba", "BombFailed")
	server_cmd(g_addStast, "Bomba Recolhida", "BombPickUp")
	server_cmd(g_addStast, "Bomba Dropada", "BombDrop")
	server_cmd(g_addStast, "Voz da Contagem da Bomba", "BombCountVoice")
	server_cmd(g_addStast, "Contagem da Bomba (defusando)", "BombCountDef")
	server_cmd(g_addStast, "TRs no Bomb Side", "BombReached")
	server_cmd(g_addStast, "Italy Bonus Kill", "ItalyBonusKill")
	server_cmd(g_addStast, "Ultimo Homem", "LastMan")
	server_cmd(g_addStast, "Frag de Faca", "KnifeKill")
	server_cmd(g_addStast, "Som de Frag de Faca", "KnifeKillSound")
	server_cmd(g_addStast, "Frag de Granada", "GrenadeKill")
	server_cmd(g_addStast, "Suicidio de Granada", "GrenadeSuicide")
	server_cmd(g_addStast, "HeadShot", "HeadShotKill")
	server_cmd(g_addStast, "Som de HeadShot", "HeadShotKillSound")
	server_cmd(g_addStast, "Contador de Rounds", "RoundCounter")
	server_cmd(g_addStast, "Som de Contador de Rounds", "RoundCounterSound")
	server_cmd(g_addStast, "Serie de Frags", "KillingStreak")
	server_cmd(g_addStast, "Som de Serie de Frags", "KillingStreakSound")
	server_cmd(g_addStast, "Inimigo Restante", "EnemyRemaining")
	server_cmd(g_addStast, "Double Kill", "DoubleKill")
	server_cmd(g_addStast, "Som de Double Kill", "DoubleKillSound")
	server_cmd(g_addStast, "Nome do Jogador", "PlayerName")
	server_cmd(g_addStast, "Som de First Blood", "FirstBloodSound")
}
