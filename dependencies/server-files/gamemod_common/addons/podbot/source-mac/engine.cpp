...
static inline void CallbackLightStyle (const unsigned char style, const char *value)
{
...
static void pfnLightStyle (int style, const char *value)
{
...
void pfnAlertMessage_Post(ALERT_TYPE atype, const char *szFmt, ...)
{
	if (atype != at_logged)
		RETURN_META(MRES_IGNORED);
