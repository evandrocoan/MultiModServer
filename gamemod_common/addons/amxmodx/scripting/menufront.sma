...
AddDefaultMenus()
{
	...
	AddMenuLang("SERVER_COM", "amx_cmdmenu", ADMIN_CFG, "Commands Menu")
	...
	AddMenuLang("CONFIG", "amx_cfgmenu", ADMIN_CFG, "Commands Menu")
	AddMenuLang("RESTART", "amx_autormenu", ADMIN_CFG, "Auto Round Restart")
	...
	AddMenuLang("SND", "amx_cmdsndmenu", ADMIN_CFG, "Addons zz Menus")
	AddMenuLang("TELE_PLAYER", "amx_teleportmenu", ADMIN_CFG, "Teleport Menu")
	AddMenuLang("MESSAGES", "amx_msgmenu", ADMIN_MENU, "Addons zz Menus")
...
public plugin_init()
{
	register_plugin("Menus Front-End", "9.0", "AMXX Dev Team")
