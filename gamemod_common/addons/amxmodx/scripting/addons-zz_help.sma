...
#define HELPAMOUNT 30	// Number of commands per page
...
public plugin_init()
{
	register_plugin("Addons zz Help", "21.0", "AMXX Dev Team")
...
{	
	...
	new CurrentTime[25] 
	get_time("%d/%m/%Y -- %H:%M:%S", CurrentTime, 24)
		
	new timeleft = get_timeleft()
	
	client_print(id, print_chat, "%L", id, "TIME_INFO", Currentmap, CurrentTime)
	client_print(id, print_chat, "%L", id, "TIME_INFO2", timeleft / 60, timeleft % 60, nextmap)
#endif
}
