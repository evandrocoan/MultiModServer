...
new sounds[10][] = 
{
"ultimate_sounds/triplekill_ut", 
"ultimate_sounds/multikill_ut", 
"ultimate_sounds/ultrakill_ut",
"ultimate_sounds/killingspree_ut", 
"ultimate_sounds/megakill_ut", 
"ultimate_sounds/holyshit_ut",
"ultimate_sounds/ludicrouskill_ut",
"ultimate_sounds/rampage_ut",
"ultimate_sounds/unstoppable_ut",
"ultimate_sounds/monsterkill_ut"
};
...
new hslist[hsounds][] = 
{
"ultimate_sounds/headshot1_ut",
"ultimate_sounds/headshot2_ut"
}

new fblist[fbsounds][]=
{
"ultimate_sounds/firstblood1_ut",
"ultimate_sounds/firstblood2_ut"
}

new preplist[prpsounds][]=
{
"ultimate_sounds/prepare1_ut",
"ultimate_sounds/prepare2_ut",
"ultimate_sounds/prepare3_ut"
}
...
new knlist[knsounds][]=
{
"ultimate_sounds/knife1_ut",
"ultimate_sounds/knife2_ut"
}

new knmessages[3][]=
{
"%s Enfiou a Faca no Bucho de %s",
"%s Foi Cuidadosamente por tras e passou a faca em %s ",	
"%s Passou a faca em %s"
}
...
{
"ultimate_sounds/suicide1_ut",
"ultimate_sounds/suicide2_ut",
"ultimate_sounds/suicide3_ut",
"ultimate_sounds/suicide4_ut"
}
...
public event_death(id) {
	...
	client_cmd(0,"spk ultimate_sounds/nade_ut")
     }
    ...
    if (is_mode_set(16)) {
      if (kills[id] > levels[0]) {
        client_print(id, print_chat, 
                     "* Voce e Killing Streak com %d Frags.", kills[id]);
      } else if (deaths[id] > 1) {
        client_print(id, print_chat, 
                     "* Caranba!!!! Voce tem uma serie de %d ate agora!!!!!!!!!!!", deaths[id]);
...
{
precache_sound("ultimate_sounds/triplekill_ut.wav")
precache_sound("ultimate_sounds/multikill_ut.wav")
precache_sound("ultimate_sounds/ultrakill_ut.wav")
precache_sound("ultimate_sounds/killingspree_ut.wav")
precache_sound("ultimate_sounds/megakill_ut.wav")
precache_sound("ultimate_sounds/holyshit_ut.wav")
precache_sound("ultimate_sounds/ludicrouskill_ut.wav")
precache_sound("ultimate_sounds/rampage_ut.wav")
precache_sound("ultimate_sounds/unstoppable_ut.wav")
precache_sound("ultimate_sounds/monsterkill_ut.wav")
precache_sound("ultimate_sounds/headshot1_ut.wav")
precache_sound("ultimate_sounds/headshot2_ut.wav")
precache_sound("ultimate_sounds/knife1_ut.wav")
precache_sound("ultimate_sounds/knife2_ut.wav")
precache_sound("ultimate_sounds/firstblood1_ut.wav")
precache_sound("ultimate_sounds/firstblood2_ut.wav")
precache_sound("ultimate_sounds/prepare1_ut.wav")
precache_sound("ultimate_sounds/prepare2_ut.wav")
precache_sound("ultimate_sounds/prepare3_ut.wav")
precache_sound("ultimate_sounds/nade_ut.wav")
precache_sound("ultimate_sounds/suicide1_ut.wav")
precache_sound("ultimate_sounds/suicide2_ut.wav")
precache_sound("ultimate_sounds/suicide3_ut.wav")
precache_sound("ultimate_sounds/suicide4_ut.wav")
precache_sound("ultimate_sounds/doublekill1_ut.wav")
precache_sound("ultimate_sounds/doublekill2_ut.wav")
}
